...
export function getSessionTokenCookie(context: Context) {
  ...
  return getSignedCookie(context, SESSION_SECRET, 'session');
}

export async function getAuthenticatedUser(context: Context) {
...
export async function getAuthenticatedUserOrThrow(context: Context) {
